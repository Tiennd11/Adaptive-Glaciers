...
xdmf = XDMFFile("output/adaptive/output.xdmf")
...
# energy_thsd= 30   # hw = 0.5-thres = 0.5, hw = 0-thres = 10
...
sigmac = 4*0.1185e6  # critical stress only for stress based method
...
csv_file_path = "output/adaptive/crevasse_depth_Multi_ad"+".csv"
